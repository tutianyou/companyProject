...
import com.xusage.statics.service.slaver.InsertNingDeExpandDataService;
...
public class InsertNingDeExpandDataController {

	@Autowired
	private InsertNingDeExpandDataService insertNingDeExpandDataService;
	...
	@RequestMapping("/insertNingDeExpandData")
	public Integer insertNingDeExpandData(Integer offset, Integer length,String consignorName) throws JsonProcessingException, Exception{
	...
	for (CommentPojo commentPojo : searchNingDeProvinceFinanical) {
	    ...
	    String expandContent  = jacksonObjectMapper.writeValueAsString(expand);
	  	...
	  	Integer expandTotalData = insertNingDeExpandDataService.insertNingDeExpandData("宁德衍生数据", expandContent);
